...
#ifdef _USEGTK3_
	gtk_dialog_add_buttons((GtkDialog*)dialog,GTK_STOCK_SAVE3,GTK_RESPONSE_YES,GTK_STOCK_CANCEL3,GTK_RESPONSE_CANCEL,GTK_STOCK_NO3,GTK_RESPONSE_NO,NULL);
#else
