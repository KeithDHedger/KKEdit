...
//			if(fd!=NULL)
//				{
//					fprintf(fd,"namet%sn",gtk_entry_get_text((GtkEntry*)toolNameWidget));
//					fprintf(fd,"commandt%sn",gtk_entry_get_text((GtkEntry*)commandLineWidget));
//					fprintf(fd,"commentt%sn",gtk_entry_get_text((GtkEntry*)commentWidget));
//					fprintf(fd,"flagst%in",flags);
//					fprintf(fd,"intermt%in",(int)inTerm);
//					fprintf(fd,"inpopupt%in",(int)inPopup);
//					fprintf(fd,"alwayspopupt%in",(int)alwaysPopup);
//					fprintf(fd,"clearviewt%in",(int)clearView);
//					fprintf(fd,"runasroott%in",(int)runAsRoot);
//					fprintf(fd,"shortcutkeyt%in",(int)gdk_keyval_from_name(gtk_entry_get_text((GtkEntry*)keyWidget)));
//					fclose(fd);
//				}
//			g_free(dirname);
//			gtk_widget_hide((GtkWidget*)data);
