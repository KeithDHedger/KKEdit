...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DocumentClass_t, stringdata) + ofs \
...
const QMetaObject DocumentClass::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_DocumentClass.data,
      qt_meta_data_DocumentClass,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DocumentClass.stringdata))
        return static_cast<void*>(const_cast< DocumentClass*>(this));
